...
/*
 16.20 On old cell phones, users typed on a numeric keypad and the phone would provide a list of words that matched these numbers.
 ...
 You are provided a list of valid words (provided in whatever data strucutre you'd like).
 */
